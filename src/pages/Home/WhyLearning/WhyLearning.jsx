  ...
  const cards = [
    {
      ...
      icon: <FaBook className="text-indigo-400 w-12 h-12" />,
    },
    {
      id: 2,
      ...
      icon: <FaSeedling className="text-green-400 w-12 h-12" />,
    },
    {
      id: 3,
      ...
      icon: <FaExclamationTriangle className="text-yellow-400 w-12 h-12" />,
    },
    {
      id: 4,
      ...
      icon: <FaLightbulb className="text-orange-400 w-12 h-12" />,
    },
  ];

  return (
    <section className="container max-w-7xl mx-auto px-4 py-16 bg-gray-900 text-gray-200">
      <SectionTitle
